...
# TODO(tsoj) use token limit instead instead of character chunk_size and overlap, inclduing knowlegde of maximum token window
def load_and_chunk_dataset(data_path, chunk_size, overlap, test_size):
    ...
    return {"train": train_dataset, "validation": test_dataset}
...
def main():
    ...
    tokenized_dataset = {
        ...
        "validation": dataset["validation"].map(preprocess_function, batched=True, remove_columns=["text"])
    }
